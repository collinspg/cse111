...
# main function
def main():
     # Get chemical formula from the user
    chemical_formula = input("Enter the chemical formula for a molecule: ")

    # Get mass of chemical sample from the user
    ...
    # Print name and atomic mass for each chemical element
    for _, name, atomic_mass in periodic_table:
